...
export function EventSheet({
  ...
  return (
    ...
    >
      ...
      <div className="max-h-[80dvh] overflow-y-auto rounded-t-2xl border-t border-line bg-paper px-4 pb-4 safe-bottom shadow-[0_-12px_40px_-12px_rgba(14,18,22,0.25)]">
        {/* Grab handle: the sheet should read as draggable-ish even though the
            only way out is Done or the backdrop. */}
