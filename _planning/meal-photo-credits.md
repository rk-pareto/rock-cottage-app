...
Photos in `public/meals/` come from Wikimedia Commons (openly licensed, no API
key needed), chosen by searching each dish's own category and picking the
closest landscape shot. They're stock photos of the *dish*, not the actual
cottage meal, so some are nearer the mark than others — `whatevers-left` and
`leftovers` are stand-ins by nature, and no photo shows the crudités that go
with the grilled cheese. Swap any of these out by replacing the file at the
same path — no code or database change needed.
...
| Chicken Skewers, Greek Salad & Lemon Potatoes | `chicken-skewers-greek-salad-lemon-potatoes.jpg` | [Souvlaki, Cypriot salad and Pitta Bread, Trimingham.JPG](https://commons.wikimedia.org/wiki/File:2017-04-17_Souvlaki%2C_Cypriot_salad_and_Pitta_Bread%2C_Trimingham.JPG) — CC BY-SA 4.0 |
| Scrambled Eggs with Yogurt & Granola | `scrambled-eggs-yogurt-granola.jpg` | [Scrambed eggs.jpg](https://commons.wikimedia.org/wiki/File:Scrambed_eggs.jpg) — CC BY-SA 3.0 |
| Beef Shishkabobs | `beef-shishkabobs.jpg` | [Shish-kebab-MCB.jpg](https://commons.wikimedia.org/wiki/File:Shish-kebab-MCB.jpg) — CC BY 3.0 |
...
| Chicken Salad | `chicken-salad.jpg` | [Chicken salad sandwich 01.jpg](https://commons.wikimedia.org/wiki/File:Chicken_salad_sandwich_01.jpg) — CC BY-SA 2.0 |
...
| Leftovers | `leftovers.jpg` | [Thanksgiving Leftover Sandwich open faced.jpg](https://commons.wikimedia.org/wiki/File:Thanksgiving_Leftover_Sandwich_open_faced.jpg) — CC BY-SA 2.0 |
