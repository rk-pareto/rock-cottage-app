# Cottage Meal Plan — Aug 31 → Sep 6, 2026
**9 people:** 5 adults + 4 kids (5.5, 4.5, 1.5 yrs, 10-wk infant). Kid-friendly, no major restrictions.
**Setup:** Full kitchen + BBQ. Grocery store close by in town.
...
### Tue — Breakfast: Pancakes, sausage, fruit · Dana & Sean
- Pancake mix (or flour + baking powder + eggs + milk — D&S bring dry goods)
- Breakfast sausage (~1 lb)
- Maple syrup (D&S bring)
- Fresh fruit (bananas, berries)

### Tue — Lunch: Grilled cheese + veggie sticks
- Good/fancy cheese (~1 lb block)
- Bread (1-2 loaves)
- Butter
- Veggie sticks (carrots, cucumber, peppers)

### Tue — Dinner: MYO pizza
- Pizza dough (or flour + yeast + olive oil)
- Pizza sauce (~1 jar)
- Shredded mozzarella (~2 cups)
- Toppings: pepperoni, mushrooms, peppers, olives, onions
- **Optional:** bagged green salad on the side (only non-green meal; low priority)

### Wed — Breakfast: Eggs, toast, fruit · Dana & Sean
- Eggs (~12)
- Toast bread
- Butter
- Fresh fruit

### Wed — Lunch: Hot dogs + raw veg
- Hot dogs / sausages (~2 pkgs)
- Buns (1 pkg)
...
- Skewers
- Marinade (soy, garlic, olive oil)
- **ADD carb + salad:** rice OR pita + a simple green salad (meat-on-a-stick alone is thin)

### Fri — Dinner: Burgers, fries, salad
- Burger patties (~2.5 lb, or fresh ground beef)
- Burger buns (1-2 pkgs)
- Cheese slices, lettuce, tomato, onion
- Condiments (ketchup, mustard, mayo)
- Fries (frozen, ~3 bags) — or fresh potatoes to cut
...
2. **Pulled pork:** ✅ **Made ahead, brought frozen** (not slow-cooked on site — no crockpot/BBQ time needed)
3. **Wed pulled-pork veg:** ✅ Add **coleslaw** (cabbage) as the crunch/vegetable for that meal
